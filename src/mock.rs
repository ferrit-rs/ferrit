...
//!
//! Phase 2 wired Status, Files and Branches to a real `git::Repo`; the mock
//! versions of those three now feed `App::mock()`, the render tests'
//! repo-free path. Commits and Stash stay mock until G4..G5. Values mirror
//! the target screen in `docs/PLAN_1_LAYOUT.md`.
